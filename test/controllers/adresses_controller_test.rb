...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { city: @adress.city, country: @adress.country, lat: @adress.lat, line_1: @adress.line_1, line_2: @adress.line_2, long: @adress.long, name: @adress.name, zip: @adress.zip } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { city: @adress.city, country: @adress.country, lat: @adress.lat, line_1: @adress.line_1, line_2: @adress.line_2, long: @adress.long, name: @adress.name, zip: @adress.zip } }
