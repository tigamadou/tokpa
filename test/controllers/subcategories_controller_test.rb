...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post subcategories_url, params: { subcategory: { activated: @subcategory.activated, category_id: @subcategory.category_id, name: @subcategory.name, slug: @subcategory.slug } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { activated: @subcategory.activated, category_id: @subcategory.category_id, name: @subcategory.name, slug: @subcategory.slug } }
